...
fh       = Dataset(options.nc_file, mode='r')
PS       = fh.variables['PS'][:]
ntimes   = PS.shape[0]
nlats    = PS.shape[1]
nlons    = PS.shape[2]
...
temp    = dataset.createVariable("QAP",np.float32,("time","level","lats","lon"))
temp[:] = mean_QAP
temp    = dataset.createVariable("TAP",np.float32,("time","level","lats","lon"))
temp[:] = mean_TAP
temp    = dataset.createVariable("QBP",np.float32,("time","level","lats","lon"))
temp[:] = mean_QBP
temp    = dataset.createVariable("TBP",np.float32,("time","level","lats","lon"))
temp[:] = mean_TBP
temp    = dataset.createVariable("dTdt_adiabatic",np.float32,("time","level","lats","lon"))
temp[:] = mean_dTdt_adiabatic
temp    = dataset.createVariable("dQdt_adiabatic",np.float32,("time","level","lats","lon"))
temp[:] = mean_dQdt_adiabatic
temp    = dataset.createVariable("SPDT",np.float32,("time","level","lats","lon"))
temp[:] = mean_SPDT
temp    = dataset.createVariable("SPDQ",np.float32,("time","level","lats","lon"))
temp[:] = mean_SPDQ
temp    = dataset.createVariable("TPHYSTND_NORAD",np.float32,("time","level","lats","lon"))
temp[:] = mean_TPHYSTND_NORAD
temp    = dataset.createVariable("PHQ",np.float32,("time","level","lats","lon"))
temp[:] = mean_PHQ
